...
\begin{figure}[H]
\includegraphics[width=0.9\textwidth]{res/img/DP/classAdapter}
...
\begin{figure}[H]
\includegraphics[width=0.9\textwidth]{res/img/DP/objectAdapter}
...
\begin{figure}[H]
\includegraphics[width=0.9\textwidth]{res/img/DP/decorator}
\caption{Decorator}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\textwidth]{res/img/DP/facade}
\caption{Façade}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.9\textwidth]{res/img/DP/proxy}
\caption{Proxy}
\end{figure}
